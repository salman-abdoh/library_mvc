...
<body>
    ...
    <div id="modlesign" class="modal2">
        <span onclick="document.getElementById('modlesign').style.display='none'" class="close" title="Close Modal">&times;</span>
        <form class="modal-content2" >
          <div class="container">
            ...
            <label>
              <input type="checkbox" checked="checked" name="remember" style="margin-bottom:15px" >اوافق علي الشروط والاحكام
            </label>
            <label>
              <input type="checkbox" checked="checked" name="remember" style="margin-bottom:15px" > التسجيل للانضمام للنشره البريديه
            </label>
    ...
    <div class="contianer">
        ...
        <nav>
            ...
            <div class="searth"><input type="search" placeholder="البحث"></div>
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade first">
              ...
              <img src="image/category2.png" style="width:95vw ">
            
            </div>
          
            <div class="mySlides fade">
              
              <img src="image/category.png" style="width: 95vw;
              height: 277px">
        ...
        <section class="catogdet">
            <div class="link">
                <ul>
                    <li><a href="index.html">الرئسية</a></li>
                    <li><a href="index.html">الكتب العربيه</a></li>
                    <li><a href="index.html">كتب الكترونيه</a></li>
                    <li><a href="index.html">لانك الله </a></li>
                </ul>

            </div>
           <div class="bookdetail">
             <div class="bookimg"> <img src="image/details.png"><div class="img">  <img src="image/details.png" class="m" height="50px" width="50px" >
                <img src="image/details.png" class="m" height="50px" width="50px" >
                <img src="image/details.png" class="m" height="50px" width="50px"></div>
            </div>
             <div style=" margin: 0 20px; font-family: system-ui;">
             <div class="bookcost"><h2>لانك الله(كتاب الكتروني)</h2>
                <h3 class="cost">ر.س 1500 <br><span>شامل الضريبه</span></h3></div>
                <div class="databook">
                 <br><span> Echo:وحدة البيع</span>
                 <br><span style="color: hsl(45deg 98% 58%);"> <span style="color: hsl(216deg 96% 41%);">(15المراجعات)</span><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                 <br><span>رقم المنتج 4 IBBdsd5رقم الصنف </span></div>
                 <div class="type">
                     <h5>الصيغ المتوفره:</h5>
                    <input type="checkbox"  checked >   كتاب الكتروني <i class="far fa-question-circle"></i> <h3 class="cost">ر.س 1500 <br><span>شامل الضريبه</span></h3><br>
                     <input type="checkbox" >  كتاب مطبوع   <h3 class="cost">ر.س 1500 <br><span>شامل الضريبه</span></h3></div>
            
            </div>
             <div class="addtocrash">
             <div class="addtocrash1">    <h5> <span> ملاحضه : </span>سيتم اضافة هذا الكتاب الالكتروني الي مكتبتك في قارئ جرير <br></h5></div>
             <div  class="addtocrash2">
                 <div class="addtocrash2_1">
                     <select>
                         <option>1</option>
                         
                     </select>
                     <button><i class="fas fa-shopping-cart"></i>اضف الي السلة</button>
                 </div >
                 <div class="addtocrash2_2">
                 <h5>  تسوق امن<i class="far fa-question-circle"></i></h5>
                 <h5>اصلي ومضمون<i class="far fa-question-circle"></i></h5>
                 <h5>شحن سريع ومجاني<i class="far fa-question-circle"></i></h5>
                
               
                 </div> 
             </div>
            
             <div  class="addtocrash3"><button><i class="fas fa-share-alt"></i> مشاركة</button>
                <button><i class="fas fa-star"></i> المفضلة</button>
                <button> <i class="fas fa-exchange-alt"></i> مقارنه</button>
            </div>
            
             <div  class="addtocrash4"><button><i class="fas fa-share-alt"></i> مشاركة</button>
                <button><i class="fas fa-star"></i> المفضلة</button>
                <button><i class="fas fa-exchange-alt"></i> مقارنه</button></div>
            </div> </div>
        </section>
        <section class="detbook">
            <h3>كتاب يتحدث عن بعض اسما الله الحسنى وكيف نتعايش معها </h3>
        </section>
       <section class="table">
           <h1>المواصفات</h1>
           <table class="tablepro">
             ...
             <tr>
                 <td class="col1">رقم الصنف</td>
                 <td class="col2">IBB1243</td>
             </tr>
             <tr>
                <td class="col1">رقم المنتج</td>
                <td class="col2">4</td>
            </tr>
            <tr>
                <td class="col1">المولف</td>
                <td class="col2">دار الحضارة للنشر والتوزيع </td>
               
            </tr>
            <tr>
                <td class="col1">تاريخ النشر</td>
                <td class="col2">2016 </td>
            </tr>
            <tr>
                <td class="col1">صيغة الكتاب</td>
                <td class="col2">Ebook </td>
            </tr>
            <tr>
                <td class="col1">عدد الصفحات</td>
                <td class="col2"> 182</td>
            </tr>
            <tr>
                <td class="col1">اللغة</td>
                <td class="col2">عربي </td>
            </tr>
           </table>
